...
//static void UIctrl_task(void const *argument);
...
int main(void)
{
  ...
  /* Thread 2 definition */
  osThreadDef(THREAD_2, Sysctrl_Thread, osPriorityNormal, 0, configMINIMAL_STACK_SIZE);
  
  /* Start thread 1 */
  UIctrl_Handle = osThreadCreate(osThread(THREAD_1), NULL);
